# Generated by Powerlevel10k configuration wizard on 2019-10-08 at 14:18 CEST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 18995.
# Wizard options: powerline, classic, lightest, time, angled separators, sharp heads,
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=10
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local  untracked='%110F'   # blue foreground
      local conflicted='%131F'  # red foreground
